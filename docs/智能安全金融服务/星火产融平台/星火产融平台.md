...
![](image\image-20230112193220449.png)
...
![image-20230112170840763](image\image-20230112170840763.png)
...
![image-20230112191149545](image\image-20230112191149545.png)
...
| &emsp;&emsp;requestNo          | 请求号                                                          | string         |                |
| &emsp;&emsp;status             | 融资处理结果：1-初始化  2-处理中  3-审批通过  4-审批退回 5-放款中 6-已放款  7-还款中 8-已还款 | string         |                |
| message                        |                                                              | string         |                |
| total                          |                                                              | integer(int32) | integer(int32) |
...
| &emsp;&emsp;requestNo     | 请求号                                                          | string             |                    |
| &emsp;&emsp;status        | 还款处理结果：1-初始化  2-处理中  3-审批通过  4-审批退回 5-放款中 6-已放款  7-还款中 8-已还款 | string(byte)       |                    |
| message                   |                                                              | string             |                    |
| total                     |                                                              | integer(int32)     | integer(int32)     |
...
![](D:/ljj/P0-区块链-0922/P0-2023年工作/其他 综合/docs/智能安全金融服务/星火产融平台/image/图片5.png)
...
- 步骤1
  ...
  ![](D:/ljj/P0-区块链-0922/P0-2023年工作/其他 综合/docs/智能安全金融服务/星火产融平台/image/图片6.png)
...
- 步骤2
  ...
  ![](D:/ljj/P0-区块链-0922/P0-2023年工作/其他 综合/docs/智能安全金融服务/星火产融平台/image/图片7.png)
...
- 步骤3
  ...
  ![](D:/ljj/P0-区块链-0922/P0-2023年工作/其他 综合/docs/智能安全金融服务/星火产融平台/image/图片8.png)
  
  ![](D:/ljj/P0-区块链-0922/P0-2023年工作/其他 综合/docs/智能安全金融服务/星火产融平台/image/图片9.png)
