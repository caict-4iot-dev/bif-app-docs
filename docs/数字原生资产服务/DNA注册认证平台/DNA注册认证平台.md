...
本使用手册共2个部分，第1部分：业务流程介绍，第2部分：平台演示。
...
备注：测试阶段：需要在**“星火测试网”**创建星火通账户并完成企业认证；
...
3）测试阶段登录测试网的DNA注册认证平台，主网对接阶段登录主网的DNA注册认证平台。

#### 1.3 测试网对接

在测试网进行应用接入测试，调用DNA相关接口。

DNA注册认证平台：https://test-dna.bitfactory.cn/manage

#### 1.4 主网对接

通过主网的DNA注册认证平台申请应用，获取apiKey/apiSecret，完成应用在主网环境对接。

DNA注册认证平台：http://dna.bitfactory.cn/manage
...
**下一步：请查阅注册/认证API接口，完成应用与DNA接口对接。**
...
参照**bif-offline-api 文档2.1章节**，参见链接https://bif-doc.readthedocs.io/zh_CN/1.0.0/tools/offlineapi.html
...
参照**bif-offline-api文档 2.9 章节**，参见链接：https://bif-doc.readthedocs.io/zh_CN/1.0.0/tools/offlineapi.html
...
参照**bif-offline-api 文档2.9 章节**，参见链接：https://bif-doc.readthedocs.io/zh_CN/1.0.0/tools/offlineapi.html
...
参照**bif-offline-api 文档2.1章节**，参见链接：https://bif-doc.readthedocs.io/zh_CN/1.0.0/tools/offlineapi.html
...
参照**bif-offline-api 文档 2.9 章节**，参见链接：https://bif-doc.readthedocs.io/zh_CN/1.0.0/tools/offlineapi.html
...
1）测网或主网gas不足。措施：提交重试，重试后若仍无法上链，联系技术人员补充星火令。

2）上链超时，可能原因链上拥堵。措施：将失败交易重新提交。
...
1）业务层激活：输入手机号hash完成业务激活，用于数据互联互通。

2）链上激活：必须保证用户BID账号有星火令且能数量足够。入参设置feelimit推荐值20,000,000
