...
星火服务平台 面向星火链网用户，包含政府、企业、骨干节点，提供了星火链网统一的 用户中心、控制台总览。支持骨干节点申请、开放平台API申请等基础服务，同时集成了其他产品服务的使用入口，辅助其他产品的使用，便于用户统一进行管理。
...
星火服务平台集成了超级节点各个产品服务入口，星火链网用户（企业、政府、骨干节点）可通过星火服务平台产品菜单页面，切换到各个产品服务平台中，便于用户操作。
...
星火链网服务平台通过星火·浏览器插件钱包链接，星火用户需要通过插件钱包登录到星火服务平台。如未案装插件钱包，请参照插件钱包产品手册进行下载、安装、创建数字身份。
