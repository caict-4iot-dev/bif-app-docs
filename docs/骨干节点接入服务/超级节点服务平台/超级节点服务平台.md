...
a) 基本信息：展示主体 BID、所属主体、入驻时间等

b) 身份授权管理：展示出该主体下的主体身份和节点身份，对其可以进行成员授权及管理。

​    身份授权展示出主体或节点身份类型、名称（主体名称和节点名称）及默认操作阈值和共管成员列表

​    点击管理员：支持新增分级管理员，删除以及权限分配。
...
（4) 节点介绍：对节点介绍，长队不能超过 200；

（5) 联系人：填写联系人姓名

（6) 联系人电话：填写联系人电话，用于审核时联系节点申请人用
...
（1) 点击「返回上一步」回到填写节点基本信息（基本信息需要回显之前填写的内容）
...
（3 ) 链架构类型：如链架构类型中，没有子链的链结构类型，可联系信通院同事进行添加
...
点击平台左上角（实际入口已产品 UI 界面为准），展示星火服务平台上架的子平台或服务，具体如下：

![img](image/wps14.jpg) 

数字身份服务平台：详见数字身份平台产品使用手册

链上签：详见链上签产品使用手册

智能合约IDE：详见链上智能合约IDE产品使用手册

公共数据服务平台：详见公共数据服务平台产品使用手册

多标识融合管理平台：详见数多标识融合管理平台产品使用手册
